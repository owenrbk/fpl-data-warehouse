...
TRUNCATE analytics.all_players;
WITH fotmob_agg AS (
    SELECT
...
INSERT INTO analytics.all_players
SELECT
...
TRUNCATE analytics.gameweeks;
INSERT INTO analytics.gameweeks
SELECT
...
TRUNCATE analytics.position_overlap;
INSERT INTO analytics.position_overlap
